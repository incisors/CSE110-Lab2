...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Register the numerical buttons to modify the display.
        // Note: we _can't_ use var here because Java needs to know what class to interpret the
        // special lambda syntax as shorthand for. Refer back to the link in Lab 1 if unsure.
        View.OnClickListener onNumBtnClicked = (View view) -> {
        ...
        for (var numBtn : numBtns) {
            numBtn.setOnClickListener(onNumBtnClicked);
        }

        // Register the dot button.
        ...
        View.OnClickListener onOpBtnClicked = (View view) -> {
            assert view instanceof Button;
            Button btn = (Button) view;
        ...
        for (var opBtn : new Button[] {btnPlus, btnTimes}) {
            opBtn.setOnClickListener(onOpBtnClicked);
        }
        ...
        btnEquals.setOnClickListener((View view) -> {
